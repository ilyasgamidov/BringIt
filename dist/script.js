...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, animate, autoplay, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, animate, autoplay, activeClass));
  }
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    key: "createPlaeyr",
    value: function createPlaeyr(url) {
